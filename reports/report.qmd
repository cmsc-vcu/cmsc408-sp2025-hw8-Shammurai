...
WHERE table_name = 'wdi_country_clean';
""")
```

## Task 5

How many countries are in the clean table?
...
```{python}
# First ensure Venezuela is in the clean table
execute_ddl(cnx, """
INSERT INTO wdi_country_clean
SELECT * FROM world_bank_data.wdi_country
WHERE `Short Name` = 'Venezuela'
...
# Set Venezuela's Income Group to NULL
execute_ddl(cnx, """
